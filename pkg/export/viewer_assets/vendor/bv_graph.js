...
export class DiGraph {
  ...
  topWhatIf(closed_set, limit, candidate_set) {
    const ptr0 = passArray8ToWasm0(closed_set, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(candidate_set)
      ? 0
      : passArray8ToWasm0(candidate_set, wasm.__wbindgen_malloc);
...
function __wbg_get_imports() {
  const import0 = {
    __proto__: null,
    __wbg_Error_67e7344beaa85059: (arg0, arg1) => {
    ...
    __wbg_error_757e9472f8410341: (arg0, arg1) => {
      let deferred0_0;
      let deferred0_1;
      try {
        deferred0_0 = arg0;
