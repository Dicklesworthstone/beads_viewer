	...
	return []StructuredTutorialPage{
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				Spacer{Lines: 1},
				Tip{Text: "Start your day with 'br ready' in the primary br stack, or 'bd ready' in a bd compatibility workspace"},
			},
		},
		{
			ID:      "concepts-labels",
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				Bullet{Items: []string{
					"Call: bv --robot-next",
					"Claim: br update ID --status=in_progress (or bd update ... in bd workspaces)",
					"Work: Do the implementation",
					"Complete: br close ID (or bd close ... in bd workspaces)",
					"Repeat",
				}},
				Spacer{Lines: 1},
		...
		// =============================================================
		{
			...
			Elements: []TutorialElement{
				...
				Code{Text: "br ready  # Primary br workflow\n# or: bd ready  # In bd compatibility workspaces"},
				...
				Bullet{Items: []string{
					...
					"br update ID --status=in_progress (or bd update ... in bd workspaces)",
				}},
				Spacer{Lines: 1},
				...
				Code{Text: "br close ID\nbr sync  # Primary br workflow\n# or: bd close ID\nbd export -o .beads/issues.jsonl  # Refresh compatibility JSONL"},
				Spacer{Lines: 1},
				Tip{Text: "Check br ready after each close - or bd ready in bd compatibility workspaces"},
			},
		},
		{
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				Bullet{Items: []string{
					...
					"Claim: br update ID --status=in_progress (or bd update ... in bd workspaces)",
					"Complete: br close ID && br sync (or bd close ... plus bd export -o .beads/issues.jsonl)",
				}},
			},
		},
		{
